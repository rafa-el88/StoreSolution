...
export class Utilities {
  ...
  public static readonly noNetworkMessageCaption = 'Sem rede';
  public static readonly noNetworkMessageDetail = 'O servidor não pode ser alcançado';
  public static readonly accessDeniedMessageCaption = 'Acesso negado!';
  public static readonly accessDeniedMessageDetail = '';
  public static readonly notFoundMessageCaption = 'Não encontrado';
  public static readonly notFoundMessageDetail = 'O recurso de destino não pode ser encontrado';
