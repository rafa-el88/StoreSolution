...
import { AlertService, AlertDialog, DialogType, AlertCommand, MessageSeverity } from './services/configs/alert.service';
...
import { LocalStoreManager } from './services/configs/local-store-manager.service';
